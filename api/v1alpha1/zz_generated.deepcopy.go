...
func (in *ComprehensionSpec) DeepCopyInto(out *ComprehensionSpec) {
	*out = *in
	in.Yield.DeepCopyInto(&out.Yield)
	if in.For != nil {
		in, out := &in.For, &out.For
		*out = make([]ForExpr, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectQuery) DeepCopyInto(out *ObjectQuery) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectQuery.
func (in *ObjectQuery) DeepCopy() *ObjectQuery {
	if in == nil {
		return nil
	}
	out := new(ObjectQuery)
